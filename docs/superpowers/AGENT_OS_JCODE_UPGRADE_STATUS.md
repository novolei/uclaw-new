...
> Current phase: PR-11 Harness campaigns ready to start
...
| PR-11 | Harness campaigns | Not started | Unassigned | Ready to start; PR-2, PR-6, PR-9, and PR-10 contract inputs are on `main`. |
...
| Current PR worktree | None; `/Users/ryanliu/Documents/uclaw` is synced to PR-10 merge commit `67005fed`. |

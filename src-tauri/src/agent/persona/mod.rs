...
pub use types::{
    ...
    PersonaKeepsakeStatus, PersonaPreset, PersonaPresetId, PersonaPromptContext, PersonaScope,
    ProposePersonaKeepsakeInput, RecordPersonaEventInput, RelationshipAffinity,

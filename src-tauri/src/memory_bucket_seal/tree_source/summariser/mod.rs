...
//!
//! Folds N buffered items into one sealed summary. Phase 3a
//! ships an [`InertSummariser`] that concatenates contributions and truncates
//! to the token budget — enough to make the tree mechanics observable
//! end-to-end without requiring an LLM. Real summarisation can slot in by

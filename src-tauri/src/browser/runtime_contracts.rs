...
pub struct BrowserProviderCapabilityCard {
    ...
    pub data_boundary_policy: &'static str,
    pub profile_storage_policy: &'static str,
    pub cost_policy: &'static str,
...
pub const BROWSER_PROVIDER_CAPABILITY_CARDS: &[BrowserProviderCapabilityCard] = &[
    BrowserProviderCapabilityCard {
        ...
        data_boundary_policy: "local_only",
        profile_storage_policy: "uclaw_isolated_profile",
        cost_policy: "included_local_runtime",
    ...
    BrowserProviderCapabilityCard {
        ...
        summary: "Fast supervised short-command Playwright lane using the official Playwright CLI.",
        ...
        harness_subjects: &["browser.playwright_cli", "browser.official_playwright_setup"],
        harness_score: BrowserProviderHarnessScore {
    ...
    BrowserProviderCapabilityCard {
        ...
        summary: "Built-in Playwright MCP lane for locator discovery, accessibility snapshots, and traces.",
        ...
        harness_subjects: &["browser.playwright_mcp", "browser.official_playwright_setup"],
        harness_score: BrowserProviderHarnessScore {
    ...
    BrowserProviderCapabilityCard {
        ...
        data_boundary_policy: "local_supervisor_only",
        profile_storage_policy: "uclaw_isolated_profile",
        cost_policy: "included_local_runtime",
    ...
    BrowserProviderCapabilityCard {
        ...
        data_boundary_policy: "explicit_task_prompt_required",
        profile_storage_policy: "ephemeral_remote_profile_only",
        cost_policy: "estimate_and_cap_required",

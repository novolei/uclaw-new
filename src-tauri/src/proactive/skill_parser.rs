...
// Shared text-dedup primitives moved to memory_graph::text_dedup (openhuman-G).
// normalize_title_for_dedup is re-exported so external callers that reference
// crate::proactive::skill_parser::normalize_title_for_dedup still compile.
pub use crate::memory_graph::text_dedup::normalize_title_for_dedup;
use crate::memory_graph::text_dedup::{
    title_bigrams, word_bigrams, jaccard_similarity,
    cjk_char_ratio, FUZZY_DEDUP_THRESHOLD,
};
